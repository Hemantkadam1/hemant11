...
app.get("/check-discount",(req,res)=>{
  ...
  if(cost > 1000)
  {
    result="User eligible for a discount";
  }
  else{
...
// Endpoimt 7:- Create an endpoint that takes the number of steps as a query parameter and returns whether the student’s attendance is low (less than 50 classes), moderate (50 to 90 classes), or high (more than 90 classes).
